            ...
            <div class="space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <select name="gender_policy" id="gender_policy" required class="flex h-9 w-full rounded-md border border-input bg-transparent px-3 py-1 text-sm shadow-sm focus:outline-none focus:ring-1 focus:ring-ring">
                        <option value="male" {{ old('gender_policy', $building->gender_policy) === 'male' ? 'selected' : '' }}>Nam</option>
                        <option value="female" {{ old('gender_policy', $building->gender_policy) === 'female' ? 'selected' : '' }}>Nữ</option>
                        <option value="mixed" {{ old('gender_policy', $building->gender_policy) === 'mixed' ? 'selected' : '' }}>Hỗn hợp (phòng vẫn đồng nhất giới tính)</option>
                    </select>
                </div>
